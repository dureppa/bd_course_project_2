...
urlpatterns = [
    ...
    path('client/<int:client_id>/',
         views.client_dashboard, name='client_dashboard'),
    path('client/<int:client_id>/catalog/',
         views.product_catalog, name='product_catalog'),
    path('api/available-products/', views.available_products_api,
         name='available_products_api'),
...
urlpatterns += [
    path('manager/<int:employee_id>/',
         manager_views.manager_dashboard, name='manager_dashboard'),
...
urlpatterns += [
    ...
    path('api/admin/assign-client/', admin_views.admin_assign_client_to_manager, name='admin_assign_client'),
